...
if (isset($_POST["submit"])){
	...
	if(editbooking($_POST)> 0){
		$_SESSION['editbooksuccess'] = 1 ;
		$bok = query("SELECT * FROM book WHERE id = $id");
	}else{
		$_SESSION["editbookfailed"] = 1;
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<li><a href="index.php"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
			...
			<li class="active"><a href="booking.php"><em class="fas fa-bookmark">&nbsp;</em> Booking</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			<div class="row">
				...
				<?php 
                if( isset($_SESSION["editbookfailed"]) == 1 ) : ?>
                ...
                unset($_SESSION['editbookfailed']);
           		 ?>

				<?php 
                if( isset($_SESSION["editbooksuccess"]) == 1 ) : ?>
				...
				<div class="col-md-4">
					...
					<div class="filler-user">
						<input type="hidden" name="id" value="<?= $bok[0]["id"];?>">
						    <div class="form-group">
								<label for="telepon">Number </label>
								</div>
							<input class="form-control" type="text" name="telepon" id="telepon" required placeholder="628122345678" value="<?= $bok[0]["telepon"];?>">
