...
$q = query("SELECT * FROM product WHERE id = $id");

if (isset($_POST["submit"])){
        $id = $_POST['id'];
    if(editourproduct($_POST)> 0){
        $_SESSION['editproductsuccess'] = 1 ;
        $q = query("SELECT * FROM product WHERE id = $id");
    }else{
        $_SESSION["editproductfailed"] = 1;
...
if (isset($_POST["upload"])){
	...
	if(uploadicon($_POST)> 0){
		$q = query("SELECT * FROM product WHERE id = $id");
		$_SESSION["uploadproductsuccess"] = 1;

	}else{
		$_SESSION["uploadproductfailed"] = 1;
	}
}
?>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="ourproduct.php"><em class="fas fa-plus-circle">&nbsp;</em> Our Product</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			<div class="row">
				<div class="col-md-12">
                <?php 
                if( isset($_SESSION["editproductfailed"]) == 1 ) : ?>
                ...
                unset($_SESSION['editproductfailed']);
           		 ?>

				<?php 
                if( isset($_SESSION["editproductsuccess"]) == 1 ) : ?>
				...
				<?php 
                if( isset($_SESSION["uploadproductfailed"]) == 1 ) : ?>
                <div class="alert bg-danger" role="alert"><em class="fa fa-lg fa-warning">&nbsp;
                ...
                unset($_SESSION['uploadproductfailed']);
           		 ?>

				<?php 
                if( isset($_SESSION["uploadproductsuccess"]) == 1 ) : ?>
                <div class="alert bg-success" role="alert"><em class="fa fa-lg fa-check">&nbsp;
                ...
                unset($_SESSION['uploadproductsuccess']);
           		 ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="10"  type="text" name="paragraf" id="paragraf"><?= $q[0]["paragraf"];?></textarea>
                    </div>
