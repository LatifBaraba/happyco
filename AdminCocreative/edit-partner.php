...
$q = query("SELECT * FROM partners WHERE id = $id");

if (isset($_POST["submit"])){
	$id = $_POST['id'];
if(editpartner($_POST)> 0){
	$_SESSION['editpartnersuccess'] = 1 ;
	$q = query("SELECT * FROM partners WHERE id = $id");
}else{
	$_SESSION["editpartnerfailed"] = 1;
	header('Location: edit-partner.php?id='.$id);
} 
}

if (isset($_POST["upload"])){
    $id = $_POST['id'];
	if(uploadeditpartner($_POST)> 0){
		$q = query("SELECT * FROM partners WHERE id = $id");
		// $_SESSION["updatehead_pic_success"] = 1;

	}else{
		// $_SESSION["updatehead_pic_failed"] = 1;
	}
}
?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			<div class="row">
				...
				<?php 
                if( isset($_SESSION["editpartnerfailed"]) == 1 ) : ?>
                ...
                unset($_SESSION['editpartnerfailed']);
           		 ?>

				<?php 
                if( isset($_SESSION["editpartnersuccess"]) == 1 ) : ?>
                ...
                <div class="filler-user">
                    <div class="form-group">
                        ...
                        <img src="asset/img/partner/<?= $q[0]['gambar'];?>" class="img-product" alt="">
					...
					<input class="form-control" type="text" name="nama" value="<?= $q[0]["nama"];?>">
