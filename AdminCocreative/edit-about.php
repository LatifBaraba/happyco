...
$q = query("SELECT * FROM visi WHERE id = $id");


if (isset($_POST["submit"])){
        $id = $_POST['id'];
    if(editaboutus($_POST)> 0){
        $_SESSION['editaboutsuccess'] = 1 ;
        $q = query("SELECT * FROM visi WHERE id = $id");
    }else{
        $_SESSION["editaboutfailed"] = 1;
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="aboutus.php"><em class="fas fa-newspaper-o">&nbsp;</em> About Us</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			<div class="row">
				<div class="col-md-12">
				<?php 
                if( isset($_SESSION["editaboutfailed"]) == 1 ) : ?>
                ...
                unset($_SESSION['editaboutfailed']);
           		 ?>

				<?php 
                if( isset($_SESSION["editaboutsuccess"]) == 1 ) : ?>
                ...
                unset($_SESSION['editaboutsuccess']);
           		 ?>
                <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <button class="btn btn-edituser-save" type="submit" name="submit">Save Data</button>
						...
						<div class="col-md-4">
							<div class="panel panel-orange" style="margin-top: 30px;">
