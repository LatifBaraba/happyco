...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			<div class="row">
				<div class="col-md-12">
				   <?php foreach ( $sld as $row ): ?>
					<div class="col-md-4">
						<div class="card text-center card-c" style="width: 100%;">
							<img class="card-img-top" src="asset/img/slider/<?= $row['gambar'];?>" alt="Card image cap" style="width: 200px;">
							<div class="card-body">
								<h5 class="card-title"><?= $row['judul'];?></h5>
								<p class="card-text"><?= $row['paragraf'];?></p>
							</div>
							<div class="card-footer footcard">
							<button class="btn btn-edit-creative" onclick="location.href='edit-slider.php?id=<?php echo $row['id'];?>'" type="button">Edit Slider</button>
							</div>
						</div>
					</div>
           		<?php endforeach; ?>
