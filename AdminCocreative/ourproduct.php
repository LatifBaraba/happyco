				...
				<table class="table table-striped table-user w-auto">
					<thead class="thead-user">
						...
						<tr>
							<td><?php echo $i;?></td>
							<td>
							<a class="button btn-edit-about" href="edit-product.php?id=<?php echo $row["id"];?>"><i class="fa fa-edit"></i>Edit</a>
							</td>
							<td><img src="asset/img/ourproduct/<?= $row["gambar"]?>" style="width: 40px;" alt=""></td>
