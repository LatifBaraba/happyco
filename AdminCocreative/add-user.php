		...
		<div class="panel panel-container">
			...
			<div class="col-md-6">
                ...
                <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="username" id="username" placeholder="Nama anda : Karin Putri" required>
                     
                            <div class="form-group">
                            <label for="email">Email </label>
                            </div>
                        <input class="form-control" type="text" name="email" id="email" placeholder="Valid email : Karin@gmail.com" required>
                    
                            <div class="form-group">
                            <label for="alamat">Address </label>
                            </div>
                        <input class="form-control" type="text" name="alamat" id="alamat" placeholder="Alamat Tinggal : Jl. Cisitu Indah 4">
           
                            <div class="form-group">
                            <label for="telepon">Phone number </label>
                            </div>
                        <input class="form-control" type="text" name="telepon" id="telepon" placeholder="Nomer Telepon : 08563369876" required>

                            <div class="form-group">
                            <label for="password">Password </label>
                            </div>
                        <input class="form-control" type="password" name="password" id="password" placeholder="Input Password" minlength="6" required>

                            <div class="form-group">
                            <label for="password2">Confirm Password </label>
                            </div>
                        <input class="form-control" type="password" name="password2" id="password2" placeholder="Repeat Password" minlength="6" required>
