			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="card text-center card-d" style="width: 100%;">
						<img class="card-img-top" src="asset/img/gallery/<?= $row['gambar'];?>" alt="Card image cap">
							<div class="card-body">
								<h4 class="card-title"><?= $row['judul'];?></h4>
								<h5><?= $row['ketjudul'];?></h5>
								<p class="card-text"><?= $row['paragraf'];?></p>
								<div class="dropbtn">
									<button class="btn btn-edit-gallery" onclick="location.href='edit-gallery.php?id=<?php echo $row['id'];?>'" type="button">Edit</button>
								</div>
							</div>
					</div>
				</div>
