...
$q = query("SELECT * FROM creative WHERE id = $id");

if (isset($_POST["submit"])){
        $id = $_POST['id'];
    if(editcreative($_POST)> 0){
        $_SESSION['editcreativesuccess'] = 1 ;
        $q = query("SELECT * FROM creative WHERE id = $id");
    }else{
        $_SESSION["editcreativefailed"] = 1;
        header('Location: edit-creative.php?id='.$id);
    } 
}

if (isset($_POST["upload"])){
    $id = $_POST['id'];
	if(uploadicon_creative($_POST)> 0){
		$q = query("SELECT * FROM creative WHERE id = $id");
		$_SESSION["uploadcreativesuccess"] = 1;

	}else{
		$_SESSION["uploadcreativefailed"] = 1;
	}
}
?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			<div class="row">
				<div class="col-md-12">
                <?php 
                if( isset($_SESSION["editcreativefailed"]) == 1 ) : ?>
                ...
                unset($_SESSION['editcreativefailed']);
           		 ?>

				<?php 
                if( isset($_SESSION["editcreativesuccess"]) == 1 ) : ?>
                ...
                unset($_SESSION['editcreativesuccess']);
           		 ?>

				<?php 
                if( isset($_SESSION["uploadcreativefailed"]) == 1 ) : ?>
                <div class="alert bg-danger" role="alert"><em class="fa fa-lg fa-warning">&nbsp;
                ...
                unset($_SESSION['uploadcreativefailed']);
           		 ?>

				<?php 
                if( isset($_SESSION["uploadcreativesuccess"]) == 1 ) : ?>
                <div class="alert bg-success" role="alert"><em class="fa fa-lg fa-check">&nbsp;
                ...
                unset($_SESSION['uploadcreativesuccess']);
           		 ?>
                ...
                <div class="filler-user">
                    <div class="form-group">
                        ...
                        <img src="asset/img/oncocreative/<?= $q[0]['gambar'];?>" class="img-product" alt="">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="judul" id="judul" value="<?= $q[0]["judul"];?>" required>
                </div>
			...
			<div class="col-md-4">
				<div class="panel panel-blue" style="margin-top: 30px;">
